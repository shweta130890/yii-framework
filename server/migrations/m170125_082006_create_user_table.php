...
class m170125_082006_create_user_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('user', ['id', 'username', 'access_token_expired_at', 'password_hash', 'password_reset_token', 'email', 'unconfirmed_email', 'confirmed_at', 'registration_ip', 'last_login_at', 'last_login_ip', 'blocked_at', 'status', 'role', 'created_at', 'updated_at'], [
