<?php
    ...
    class UserController extends ActiveController
    {
        ...
        public function behaviors()
        {
            ...
            $behaviors['authenticator']['except'] = ['delete', 'options', 'login', 'signup', 'confirm', 'password-reset-request', 'password-reset-token-verification', 'password-reset'];
        ...
        public function actionLogin() {
            ...
            if ($model->load(Yii::$app->request->post()) && $model->login()) {
                ...
                // Validation error
                throw new HttpExcepption(422, json_encode($model->errors));
            }
        }
